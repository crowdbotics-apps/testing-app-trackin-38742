...
## Project Structure
    ...
    ├── testing_app_trackin_38742  # Django project configurations
...
1. Clone this repo and `cd testing_app_trackin_38742`
...
2. Clone this repo and `cd testing_app_trackin_38742`
